    ...
    <main className="h-screen flex flex-col items-center justify-between">
      <header className="mt-6 w-[940px]  p-5 fixed top-0 left-1/2 -translate-x-1/2 z-10 bg-[#191919] rounded-xl shadow-md border border-[#3c3c3c] flex flex-row gap-6">
        ...
        <div className="self-center ml-auto">
          <button className="py-2 px-3 rounded-md text-sm font-medium text-blue-500 flex flex-col items-center gap-1 bg-opacity-10 hover:bg-opacity-80 hover:text-slate-50 ease-in-out transition-all duration-300 hover:bg-[#F46363] border border-1">
            Export as PNG
